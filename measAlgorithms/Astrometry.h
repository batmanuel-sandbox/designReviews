...
/************************************************************************************************************/
/**
 * A class to provide the implement the Astrometry interface, and provide a class containing the
 * data (using the CRTP --- XxxAstrometry ultimately derives from MeasurementData<XxxAstrometry, Astrometry>)
 */
template<typename T>
class AstrometryImpl : public MeasurementData<T, Astrometry> {
public:
    /// Return the x-centroid
    virtual double getX() const {
        return MeasurementData<T, Astrometry>::template get<Astrometry::X, double>();
    }
    /// Return the error in the x-centroid
    virtual float getXErr() const {
        return MeasurementData<T, Astrometry>::template get<Astrometry::X_ERR, float>();
    }
    /// Return the y-centroid
    virtual double getY() const {
        return MeasurementData<T, Astrometry>::template get<Astrometry::Y, double>();
    }
    /// Return the error in the y-centroid
    virtual float getYErr() const {
        return MeasurementData<T, Astrometry>::template get<Astrometry::Y_ERR, float>();
    }
};
